...
# Função de cálculo dos valores trigonométricos
def calcular():
    try:
...
# Função para limpar a entrada e os resultados
def limpar():
...
label_angulo = tk.Label(frame_entrada, text="Ângulo (0 a 90):", font=('Arial', 14), bg="#f0f0f0")
label_angulo.pack(pady=(0, 5))

validacao = janela.register(validar_entrada)
entrada_angulo = tk.Entry(frame_entrada, width=8, justify='center', font=('Arial', 16),
